# [Platinum V] Table 10 - 22231 

[문제 링크](https://www.acmicpc.net/problem/22231) 
...
브루트포스 알고리즘(bruteforcing), 구성적(constructive), 구현(implementation), 수학(math), 정수론(number_theory), 무작위화(randomization)
