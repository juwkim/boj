# [Gold I] Table 9 - 22230 

[문제 링크](https://www.acmicpc.net/problem/22230) 
...
브루트포스 알고리즘(bruteforcing), 구성적(constructive), 수학(math), 런타임 전의 전처리(precomputation), 무작위화(randomization)
